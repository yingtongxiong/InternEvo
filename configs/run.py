...
# 定义替换变量的值
test1_variables = {
    "seq_len": [128 * 1024, 256 * 1024, 512 * 1024, 1024 * 1024],#, 512 * 1024, 1024 * 1024],
...
root_path = "7B-time/barrier-head-first-mha"
...
for i, combination in enumerate(combinations):
    ...
    command = f"srun -p llm_s -N 8 -n 64 --ntasks-per-node=8 --gpus-per-task=1 --cpus-per-task=16 python ../train.py --config ./{output_path} 2>&1 | tee '{log_path}'"
